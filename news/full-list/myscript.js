...
btn.onclick = function(){
  modal.style.display = "block";
  modalImg.src = "/img/IWMG2019.jpg";
  captionText.innerHTML = "International Workshop on Materials Genomics 2019";
}
...
btn.onclick = function(){
  modal.style.display = "block";
  modalImg.src = "/img/Xian2019.jpg";
  captionText.innerHTML = "1st International Symposium on Computational Structure Prediction and Advanced Materials 2019";
}
...
btn.onclick = function(){
  modal.style.display = "block";
  modalImg.src = "/img/conf_2021.jpg";
  captionText.innerHTML = "International Symposium on Emerging Electronic Materials 2021";
}
...
btn.onclick = function(){
  modal.style.display = "block";
  modalImg.src = "/img/imperial2022.jpg";
  captionText.innerHTML = "Departmental Seminar of Imperial College London 2022";
}
